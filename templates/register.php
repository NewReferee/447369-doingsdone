...
<form class="form" action="register.php" method="post">
  <div class="form__row">
    ...
    <input class="form__input <?php if (array_intersect($errors, ['invalid-email', 'exist-email'])): ?> <?= 'form__input--error' ?> <?php endif; ?>" type="text" name="email" id="email" value="" placeholder="Введите e-mail">
  ...
  <div class="form__row">
    ...
    <input class="form__input <?php if (array_intersect($errors, ['empty-password'])): ?> <?= 'form__input--error' ?> <?php endif; ?>" type="password" name="password" id="password" value="" placeholder="Введите пароль">
  </div>
  ...
  <div class="form__row">
    ...
    <input class="form__input <?php if (array_intersect($errors, ['empty-name', 'exist-name'])): ?> <?= 'form__input--error' ?> <?php endif; ?>" type="text" name="name" id="name" value="" placeholder="Введите имя">
  </div>
